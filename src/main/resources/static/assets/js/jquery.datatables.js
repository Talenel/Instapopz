...
(function( $, window, document, undefined ) {
	...
	/**
	 * Object com.example.demo.models container, for the various com.example.demo.models that DataTables has
	 * available to it. These com.example.demo.models define the objects that are used to hold
